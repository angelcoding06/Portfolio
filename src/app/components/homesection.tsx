			...
			<div className="flex flex-col md:flex-row items-center justify-between">
				<div className="md:pr-12 pb-5 md:pb-0">
					<h1 className="font-extrabold text-black dark:text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal justify-center">
						<span>Hello!</span>
						<span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-purple-500 to-[#ff8949]">
							{Title}
						</span>
					</h1>
					...
					<div>
						<Link
							href="/#projects"
							className="font-bold px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-emerald-500 via-purple-500 to-[#ff8949] hover:bg-slate-200 text-white text-center"
						>
							My Projects
						</Link>
						...
						<Link
							href="/#contact"
							className="font-bold px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-emerald-500 via-purple-500 to-[#ff8949] hover:bg-slate-800 text-white mt-3 text-center"
						>

			...
			<div className="flex flex-col gap-y-8">
				<ProjectArticle
					...
					ProjectDescriptionoptional={
						"The main features were; profile creation, authentication, products CRUD, global dark mode using custom hooks and context, add to cart, add to favorites, MercadoPago integration."
					}
					skills={skills}
					image={HomePageTiun}
